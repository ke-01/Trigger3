...
if args.model_type=='gector':
    train_src_file='./dataset/qq_train_ft_gector_src.txt'
    train_trg_file='./dataset/qq_train_ft_gector_trg.txt'
elif args.model_type=='bart':
    train_src_file='./dataset/qq_train_ft_bart_src.txt'
    train_trg_file='./dataset/qq_train_ft_bart_trg.txt'
elif args.model_type=='t5':
    train_src_file='./dataset/qq_train_ft_t5_src.txt'
    train_trg_file='./dataset/qq_train_ft_t5_trg.txt'
